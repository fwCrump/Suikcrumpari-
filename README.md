...
- Don't use auras, as they may interfere with the macro
  - Alternatively, use **Auto Aura Unequip** (might bug out, can't fix).
...
The macro currently covers roughly **1/3rd to half of the map**. More areas may be added in the future, let me know
The macro is **inefficient in terms of tickets** and prioritizes **speed**.
